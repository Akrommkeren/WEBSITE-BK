...
<style>
    ...
    .status-in_progress_design { background: #fce4ec; color: #880e4f; }
        ...
        <table class="manage-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="showUpdateForm('{{ $project->id }}')" style="background: #e91e63; color: white; border: none; padding: 5px 10px; border-radius: 3px; cursor: pointer;">Update Progress</button>
                    </td>
                </tr>
                        ...
                        <div style="padding: 15px;">
                            ...
                            <form action="{{ route('management.project.progress', $project->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-top: 10px;">
                                    ...
                                    <div>
                                        <label>Dokumentasi (File/Preview)</label>
                                        <input type="file" name="completion_docs" style="width: 100%; padding: 8px; margin-top: 5px;">
                                    </div>
                                    <div>
                                        <label>URL (Figma/Canva/Drive)</label>
                                        <input type="url" name="completion_url" value="{{ $project->completion_url }}" style="width: 100%; padding: 8px; margin-top: 5px;" placeholder="https://figma.com/file/...">
                                    </div>
                                </div>
                ...
                @empty
                <tr>
                    <td colspan="5" style="text-align: center;">Tidak ada project design aktif saat ini.</td>
                </tr>
                @endforelse
            </tbody>
        </table>

...
@section('title', 'Manajerial Designer')
...
<div class="feed-full">
    <div class="manage-card">
        <h2 class="title-daftar-project">Daftar Project - Designer</h2>
        ...
        <div style="overflow-x: auto;">
            <table class="manage-table">
                ...
                <tbody>
                    <!-- CONTOH DATA DUMMY DESIGNER -->
                    @if($projects->isEmpty())
                    <tr>
                        <td>BK-2026-0004</td>
                        <td>Creative Studio Hub</td>
                        <td>Design</td>
                        <td>2026-05-22</td>
                        <td>2026-05-30</td>
                        <td><span class="status-badge status-in_progress_design">In Progress</span></td>
                        <td>
                            <button onclick="toggleUpdateForm('dummy-design-1')" style="background: #1877f2; color: white; border: none; padding: 6px 12px; border-radius: 6px; cursor: pointer; font-weight: bold;">Update Progres</button>
                        </td>
                    </tr>
                    <tr id="form-dummy-design-1" style="display: none; background: #f0f2f5;">
                        <td colspan="7">
                            <div style="padding: 20px;">
                                <div style="background: white; padding: 15px; border-radius: 8px; margin-bottom: 15px; border: 1px solid #ddd;">
                                    ...
                                    <p><b>Catatan Klien:</b> Desain logo minimalis dengan warna pastel.</p>
                                    <p><b>Instruksi Admin:</b> Berikan 3 alternatif konsep awal.</p>
                                </div>

                                <div style="background: white; padding: 20px; border-radius: 8px; border: 1px solid #ddd;">
                                    <h4 style="margin-top: 0;">Update Progres & Hasil Design</h4>
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 15px;">
                                        <div>
                                            <label style="display: block; font-weight: bold; margin-bottom: 5px;">File Design (Zip/Image/PDF)</label>
                                            <input type="file" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 6px;">
                                        </div>
                                        <div>
                                            <label style="display: block; font-weight: bold; margin-bottom: 5px;">Link Aset (Drive/Figma/Link)</label>
                                            <input type="url" placeholder="https://..." style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 6px;">
                                        </div>
                                    </div>
                                    <div style="display: flex; justify-content: flex-end;">
                                        <button type="button" class="btn-action" style="background: #28a745; color: white; border: none; padding: 10px 25px; border-radius: 6px; cursor: pointer; font-weight: bold;" onclick="alert('Data design diserahkan ke admin!')">Serahkan ke Admin</button>
                                    </div>
                                </div>
                            </div>
                        </td>
    ...
    <div class="notif-box">
        ...
        <div id="notifList">
            <div class="notif-item">
                <p>Ada project baru untuk divisi Designer!</p>
